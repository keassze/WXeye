...
+ (UIColor *) ZNavBarTeal
{
    return [UIColor colorWithRed:0/255.0 green:128/255.0 blue:128/255.0 alpha:1.0];
}

+ (UIColor *) ZNavBarGlobalBlue
{
    return [UIColor colorWithRed:0.0f/255.0f green:124.0f/255.0f blue:194.0f/255.0f alpha:1.0f];
}
